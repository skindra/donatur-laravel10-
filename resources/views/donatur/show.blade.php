    ...
    <div class="col">
        <div class="pt-4 d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-center flex-wrap align-content-start">
                ...
                @can('delete', $donatur)
                    <form onsubmit="return confirm('Apa anda yakin akan menghapus ini?');" action="{{ url('/donaturs/' . $donatur->id) }}" method="POST">
                        @method('DELETE')
    ...
    <div class="table-responsive">
        ...
        <ul class="list-group list-group-numbered">
            ...
            <li class="list-group-item d-flex flex-wrap" style="word-break: break-all;">Map :
                @if ($donatur->map != '-')
                    <a name="" id="" class="btn-link" target="_blank" href=" {{ $donatur->map }}" role="button">
                        {{ $donatur->map }}</a>
                @endif
